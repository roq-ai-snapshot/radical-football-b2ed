...
CREATE TABLE "player_parent" (
    ...
    CONSTRAINT "player_parent_pkey" PRIMARY KEY ("player_id","parent_id")
);
...
-- AddForeignKey
ALTER TABLE "player_parent" ADD CONSTRAINT "player_parent_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "parent"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "player_parent" ADD CONSTRAINT "player_parent_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
